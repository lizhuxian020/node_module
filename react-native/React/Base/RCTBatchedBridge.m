...
#pragma mark - RCTJavaScriptExecutorDelegate
- (NSString *)loadBundleContentWithBundleId:(NSString *)bundleId{
    if([self.delegate respondsToSelector:@selector(loadBundleContentWithBundleId:)]){
        return [self.delegate loadBundleContentWithBundleId:bundleId];
    }
    return nil;
}
